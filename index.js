...
var items1 = ['真面目','ユーモラス','クール','キュート','不思議','天才','努力家','完璧','ヤンキー','酒豪','深爪','健康','不愉快','太陽みたい','情熱的','楽観的','ビビり','ムッツリ','アホ','変態','バカ','好奇心旺盛','欲求不満','スケベ','エッチ']
var items2 = ['成績優秀','スポーツ万能','料理が上手','声が綺麗','笑顔が素敵','女装が似合いそう','学校休んで風俗に行ってそう','笑い方が独特','髪型が変','おしゃれ','飛田新地に行ってそう','臭そう','早漏','服のセンスが変','賢そう','鼻毛が多そう','頭が悪そう','サイコパス','積極的','不真面目','淫乱','貪欲','ドS','ドM','敏感']
